...
// console.log(`Olá ${nome}! A próxima dose da ${vacinaCorona} é daqui a ${} dias. Compareça no posto na data ${}.`)

const primeiraDose = ( nome, vacinaCorona)=> {
let tempo = '28'
let data = '18/06/2022'
if(vacinaCorona === tempo && vacinaCorona === data){
  tempo.push(nome, vacinaCorona)
  return primeiraDose
}
...
console.log (`Olá ${nome}! A próxima dose da ${vacinaCorona} é daqui a ${tempo} dias. Compareça no posto na data ${data}.`)
