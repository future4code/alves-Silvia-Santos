...
R: Para acessar valores das Frutas.
...
Digitsr o primeiro número

b) Considere um usuário digitou o número 10. Qual será a mensagem do terminal? E se fosse o número -10?

Se fosse 10, passaria no teste porque 10 é > 0
...
1- 1. Faça um programa que pergunta ao usuário qual a idade dele e imprima no console 
se ele/ela pode dirigir (apenas maiores de idade).
    

    a) Faça um `prompt` para receber a idade do usuário e guarde em uma variável.
    
    b) Garanta que essa variável é do tipo `Number`, você deve usar o cast para number
     para isso.
    ...
    dirigir. Se sim, imprima no console `"Você pode dirigir"`, caso contrário, imprima
     ...
     //let turnoAluno = prompt("V (Vespertino)")
    ...
    // }
     ...
     // let turnoDoAluno = prompt("V (Vespertino)").toUpperCase()
   ...
   // switch (turnoDoAluno){
    // case 'M':
     ...
     //case 'N':
       // console.log("Boa Noite!")
     //default:
       //  console('Turno não encontrado.')
        //break   
    //}



     /* 4-Considere a situação: você vai ao cinema com um amigo ou amiga, porém ele/ela
     só assistirá a um filme com você se ele for do gênero fantasia e se o ingresso 
     está abaixo de 15 reais. Faça um código que pergunta ao usuário qual o gênero de
    filme que vão assistir e outra pergunta sobre o preço do ingresso, então verifique
     se seu amigo ou amiga vai topar assistir o filme. Caso positivo, imprima no 
    ...
    //const valorIngresso = Number(prompt("Qual o valor do filme?"))
